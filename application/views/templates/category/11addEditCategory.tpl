...
<!-- /Title -->
<!-- Row -->
<form method="post" action="{$data.base_url}admin/Category/{$mode}" id="add_Category_frm" name="add_Language_frm" enctype='multipart/form-data' >
			...
			<div class="panel-wrapper collapse in">
				<div class="panel-body">
					<div class="row">
						<div class="form-wrap">
						 <div class="col-md-12">
						    <input type='hidden' name='iCategoryId' id='iCategoryId' 
						    value ="{$singleRecord.iCategoryId}">
								<div class="col-md-6">
							        ...
							        <div class="form-group">
										...
										{else}			
											<div class="fileinput fileinput-new input-group" data-provides="fileinput">
											    ...
											    <input type="file" name="tImage" id="tImage" class="form-control required" style="display:none;"onchange="return checkValidImage(this.value)" >
													</span> 
											</div>
											<span class="msgformat1" style="color: red;">
					 							[Image extension Must Be Png, Jpg and JPEG allowed.]
												</span>
											<p class="help-block1 errcolor" id="err_tPhoto_area"><img class="validationimg" src="{$base_url}assets/common/img/arrow.png"><span class="errvalidationtext" id="lbltPhotoerrmsg" ></span></p>
										{/if}	
									</div>
								</div>	
							</div>
							...
							<div class="col-md-12 btnTopSpc">
							  <div class="col-md-6">
								<div class="form-group">
									<button type="submit" class="btn btn-success mr-10 btnFrmTopSpc" >Save</button>
