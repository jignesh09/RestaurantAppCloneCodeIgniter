...
<form action="{$base_url}admin/Item/actionUpdate"  method='post' role="form">
						...
						<div class="table-responsive">
							<table id="table" class="table table-hover display  pb-30" >
								...
								<tbody>
									...
									<tr>
										<td><center><input id="iId" name="iId[]" type="checkbox" value="{$value.iItemId}"></center></td>
									    ...
									    <td><center><a href="{$base_url}admin/Item/edit/{$value.iItemId}"><i class="fa fa-edit"></i></a></center></td>
									</tr>
									{/foreach}
								</tbody>
							</table>
...
function redirectme()
{
	...
	window.location = "{$data.base_url}Item/add";
}
