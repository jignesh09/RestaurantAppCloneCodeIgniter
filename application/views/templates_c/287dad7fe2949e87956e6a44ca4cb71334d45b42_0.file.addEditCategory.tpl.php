<?php
/* Smarty version 3.1.30, created on 2018-01-25 16:18:34
  from "/var/www/html/CI_demo_projects/RestaurantApp/application/views/templates/category/addEditCategory.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a69b602399ad7_83501925',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '287dad7fe2949e87956e6a44ca4cb71334d45b42' => 
    array (
      0 => '/var/www/html/CI_demo_projects/RestaurantApp/application/views/templates/category/addEditCategory.tpl',
      1 => 1516876828,
      2 => 'file',
    ),
  ),
...
function content_5a69b602399ad7_83501925 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
admin/Category"><span>List Category</span></a></li>
...
admin/Category/<?php echo $_smarty_tpl->tpl_vars['mode']->value;?>
" id="add_Category_frm" name="add_Category_frm" enctype='multipart/form-data' >
<input type='hidden' name='iCategoryId' id='iCategoryId' value = "<?php echo $_smarty_tpl->tpl_vars['singleRecord']->value['iCategoryId'];?>
">
<div class="row">
	<div class="col-md-12">
...
" placeholder="Enter Title">
											...
											<p class="help-block1 errcolor" id="errTitleArea"><img class="validationimg" src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/common/img/arrow.png"><span class="errvalidationtext" id="lbltitlemsg"></span></p>
...
admin/Category/removeImage/category/<?php echo $_smarty_tpl->tpl_vars['singleRecord']->value['iCategoryId'];?>
">
										...
										<?php } else { ?>			
											...
											<p class="help-block1 errcolor" id="errPhotoArea"><img class="validationimg" src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/common/img/arrow.png"><span class="errvalidationtext" id="lblPhotomsg" ></span></p>
										<?php }?>	
									</div>
								</div>	
							</div>
...
assets/common/img/arrow.png"> <span class="errvalidationtext" id="lblstatuserrmsg"></span></p>
							...
							<div class="col-md-12 btnTopSpc">
							  <div class="col-md-6">
								<div class="form-group">
									<button type="button" class="btn btn-success mr-10 btnFrmTopSpc" onclick="return categoryFormValidation('<?php echo $_smarty_tpl->tpl_vars['mode']->value;?>
');">Save</button>
									<a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
admin/Category">
								<button type="button" class="btn btn-danger btnFrmTopSpc" onclick="returnme('<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
admin/Category')">Cancel</button></a>
									</div>
								</div>
							</div>
						</div>
...
assets/common/js/categoryValidation.js"><?php echo '</script'; ?>
>
<?php }
}
